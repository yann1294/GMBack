...
import { BookingVO } from '../vo/booking.master.vo';
  ...
  @Injectable()
  export class TourValidationPipe implements PipeTransform<any, Promise<BookingVO>> {
    ...
    async transform(value: any, metadata: ArgumentMetadata): Promise<BookingVO> {
      ...
      const tourDto = this.origin == "update" ? plainToInstance(UpdateBookingDTO, value) : plainToInstance(BookingDTO, value);
