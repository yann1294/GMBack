...
export class AdminService implements IAdminService {
  constructor(
    ...
    @Inject(TOURIST_SERVICE_TOKEN)
    private readonly touristService: ITouristService, // Inject TouristService
  ) {}

  // Admin related methods

  findAdmin(uid: string): Promise<ResponseObject> {
    // takes the uid and passes it to the DAO
    return this.adminDAO.findById(uid);
  }
